...
<div id="dataModal" class="hidden fixed bg-gray-600 bg-opacity-50 overflow-y-auto z-50">
    ...
    <div class="relative mx-auto p-5 border w-1/2 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            ...
            <div class="items-center px-4 py-3">
                <button id="closeModal" class="px-4 py-2 bg-gray-800 text-white text-base font-medium rounded-md w-full shadow-sm hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Fechar</button>
            </div>
        </div>
    </div>
</div>
...
searchIcon.addEventListener('click', () => {
    ...
    fetch('/buscar-dados') // Substitua '/buscar-dados' pela sua rota
        ...
        .then(data => {
            ...
            let content = '';
            data.forEach(item => {
                content += `Descrição: ${item.description}, Latitude: ${item.latitude}, Longitude: ${item.longitude}<br>`;
            });

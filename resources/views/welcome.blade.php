                            ...
                            <form action="{{ route('points.store') }}" method="POST">
                                ...
                                <!-- <div class="grid gap-6 lg:grid-cols-2">
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            <input type="text" name="description" id="description" class="block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid gap-6 lg:grid-cols-2">
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            <input type="text" name="latitude" id="latitude" class="block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid gap-6 lg:grid-cols-2">
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            <input type="text" name="longitude" id="longitude" class="block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                        </div>
                                    </div>
                                </div>

                                <button type="submit" class="w-full bg-[#FF2D20] hover:bg-[#FF2D20]/90 text-white font-bold py-2 px-4 rounded">Add</button>
                            </form>
                        </div> -->
